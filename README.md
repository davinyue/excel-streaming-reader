...
The latest versions of this library (3.x) have dropped support for Java 7. This is due to POI 5.0 requiring Java 8; as that is a core dependency of this library, it cannot support older versions of Java. The older 1.x and 0.x versions will no longer be maintained.
...
log4j.category.org.rdlinux=DEBUG
```
